...
public class Restaurant implements Serializable {
    ...
    public Restaurant(  String name, String address, double rating, double latitude, double longitude, int distance,
                        int nbWorkmates, String phoneNumber, String website, String isOpenNow, String imageUrl, String placeId) {
        this.name= name;
